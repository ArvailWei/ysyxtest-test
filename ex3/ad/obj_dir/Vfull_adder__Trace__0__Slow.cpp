...
VL_ATTR_COLD void Vfull_adder___024root__trace_full_sub_0(Vfull_adder___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelf->full_adder__DOT__s1));
    bufp->fullBit(oldp+7,(((IData)(vlSelf->a) & (IData)(vlSelf->b))));
    bufp->fullBit(oldp+8,(((IData)(vlSelf->in_c) & (IData)(vlSelf->full_adder__DOT__s1))));
}
