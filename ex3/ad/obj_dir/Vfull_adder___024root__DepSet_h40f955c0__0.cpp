...
VL_INLINE_OPT void Vfull_adder___024root___ico_sequent__TOP__0(Vfull_adder___024root* vlSelf) {
    ...
    // Body
    vlSelf->full_adder__DOT__s1 = ((IData)(vlSelf->a) 
                                   ^ (IData)(vlSelf->b));
    vlSelf->out_s = ((IData)(vlSelf->in_c) ^ (IData)(vlSelf->full_adder__DOT__s1));
    vlSelf->out_c = (((IData)(vlSelf->a) & (IData)(vlSelf->b)) 
                     | ((IData)(vlSelf->in_c) & (IData)(vlSelf->full_adder__DOT__s1)));
}
